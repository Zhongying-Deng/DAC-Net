...
# Domain Attention Consistency Network (DAC-Net)
_C.TRAINER.DACNET = CN()
_C.TRAINER.DACNET.LOSS_TYPE = 'L1'
_C.TRAINER.DACNET.WEIGHT_D = 0.3  # DAC loss weight
_C.TRAINER.DACNET.WEIGHT_CON = 0.1  # class compactness loss weight
